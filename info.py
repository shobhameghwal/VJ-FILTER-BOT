...
API_ID = int(environ.get('API_ID', '24780843'))
API_HASH = environ.get('API_HASH', '9d5c66ccdb050e7ce543d41d67a5a287')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002200531473'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6570924817').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002223388865').split()]
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002061230480')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002061230480')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', -1002200531473))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '')).split()]
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://shobhameghwal786:1NfZMJccBvVnM5b5@cluster0.litexue.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'pankaj_sirsa') # owner username without @
...
LANGUAGES = ["Hindi", "Punjabi", "English", "Haryanvi" ,"South Indian", "Hollywood",]
